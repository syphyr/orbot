...
class ConfigConnectionBottomSheet :
    ...
    override fun onCreateView(
        ...
        val radios = arrayListOf(rbDirect, rbSnowflake, rbSnowflakeAmp, rbSnowflakeSqs, rbMeek, rbRequestBridge, rbCustom)
        ...
        val allSubtitles = arrayListOf(
            tvDirectSubtitle, tvSnowflakeSubtitle, tvSnowflakeAmpSubtitle, tvSnowflakeSqsSubtitle, tvMeekSubtitle, tvRequestSubtitle, tvCustomSubtitle
        )
