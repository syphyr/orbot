...
class VpnAlwaysOnDialogFragment : DialogFragment() {

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        super.onCreateDialog(savedInstanceState)
        val msg = arguments?.getString(EXTRA_MESSAGE)
    ...
    companion object {
        ...
        fun newInstance(message: String): VpnAlwaysOnDialogFragment =
            VpnAlwaysOnDialogFragment().apply {
